 ...
 */
final class Version20230424122508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD lieu_id INT DEFAULT NULL, ADD campus_id INT NOT NULL, ADD etat_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD sorties_id INT DEFAULT NULL, ADD campus_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64915DFCFB2 FOREIGN KEY (sorties_id) REFERENCES sortie (id)');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649AF5D55E1 FOREIGN KEY (campus_id) REFERENCES campus (id)');
        $this->addSql('CREATE INDEX IDX_8D93D64915DFCFB2 ON user (sorties_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D64915DFCFB2');
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D649AF5D55E1');
        $this->addSql('DROP INDEX IDX_8D93D64915DFCFB2 ON user');
        $this->addSql('DROP INDEX IDX_8D93D649AF5D55E1 ON user');
        $this->addSql('ALTER TABLE user DROP sorties_id, DROP campus_id');
        ...
        $this->addSql('ALTER TABLE sortie DROP lieu_id, DROP campus_id, DROP etat_id');
